...
#----------------------------------
    ...
    function WriteStrikePrice_1 { #START FUNCTION
       ...
       write-host -nonewline "Three-Year,24-month Exit : `$$36MonthCalc | Shaved Exit @ 90% : `$$36MonthShave | Strike : "
        write-host "`$$36StrikePrice" -f yellow -b black
        write-host -nonewline " Two-Year, 16-month Exit : `$$18MonthCalc | Shaved Exit @ 90% : `$$18MonthShave | Strike : "
    ...
    function WriteStrikePrice_2 { #START FUNCTION
        ...
        write-host -nonewline " Three-Year, 36-month Exit : `$$36MonthCalc | Shaved Exit @ 90% : `$$36MonthShave | Strike : "
...
#    write-host "=============================================================" 
    ...
    write-host "-------------------------------------------------------------------------------------"
    write-host ""
    write-host "                              *** BLACK PANTHER STRIKE PRICE ***                                " -f yellow
    write-host "-------------------------------------------------------------------------------------"
    WriteStrikePrice_1
    #write-host "-------------------------------------------------------------------------------------"
    #write-host ""
...
function HeaderInfo { #START FUNCTION
    ...
    $filename = split-path $MyInvocation.PSCommandPath -Leaf
    $dateOfRelease="Released version: 09 Sep 2020"
